...
export const demoVideos: Video[] = [
  demoVideo({
    ...
    format: '16:9',
    preset: 'dolly',
    recipe: 'dashboard-zoom',
    variationTitle: 'dashboard hero',
    status: 'ready',
  ...
  brand: {
    ...
    analysis: {
      ...
      visuals: [
        {
          kind: 'dashboard',
          label: 'analytics dashboard with line chart',
          bbox: { x: 120, y: 420, w: 1200, h: 720 },
          cropPath: null,
          hero: true,
        },
        {
      ...
      story: {
        hook: 'ship your saas before your coffee gets cold',
        beats: ['the problem', 'the dashboard', 'the proof', 'the cta'],
      },
    },
  },
};
